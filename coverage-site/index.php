...
if(empty($_GET["filename"])){
	$anav .=" <a class=\"brand\" href=/ style=\"".(!$_GET['doctest'] && !$_GET['notdoctest']?"color: white;":"")."\">Home</a> <a class=\"brand \" style=\"".($_GET['doctest']?"color: white;":"")."\" href=\"".($_GET['doctest'] ? "?query=".$_GET['query'] : "?doctest=1&query=".$_GET['query'])."\">@Doctest</a> <a class=\"brand \" style=\"".($_GET['notdoctest']?"color: white;":"")."\" href=\"".($_GET['notdoctest'] ? "?query=".$_GET['query'] : "?notdoctest=1&query=".$_GET['query'])."\">!Doctest</a>     <form class=\"navbar-search pull-right\" method=get> <font color=white>Advanced filename search</font> <input type=hidden name=doctest value=\"".$_GET['doctest']."\"> <input type=hidden name=notdoctest value=\"".$_GET['notdoctest']."\"><input type=\"text\" name=\"query\" value=\"".$_GET['query']."\" class=\"search-query\" placeholder=\"Ex: not like '%atk%' \"></form> </div></div></div>\n";
	echo $anav;
	...
	<thead style=\"background-color: #000000\">
		<tr>
			...
			<td style=\"0px solid;\"><strong><p class=\"text-warning\">Doctest</strong></p></td>
	...
	echo "<div class=anav> <a class=\"brand\" href=/>Home</a>
